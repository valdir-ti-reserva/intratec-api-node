...
var Compliment_1 = require("../entities/Compliment");
var ComplimentsRepositories = /** @class */ (function (_super) {
    __extends(ComplimentsRepositories, _super);
    function ComplimentsRepositories() {
